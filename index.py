...
def search_products(query):
    query = query.lower()
    return [p for p in load_json(PRODUCTS_FILE) if query in p["name"].lower() or query in p.get("description", "").lower()]


def show_memberships():
    return load_json(MEMBERSHIPS_FILE)
